...
def getTradeProbabilities(ticker, risk, reward, leverage):
...
def displayStats(risk, RewardRiskRatio, leverage, showIndividualTrades):
    ...
    for ticker in tickers:
        trade = getTradeProbabilities(ticker, risk, risk * RewardRiskRatio, leverage)
        trades.append(trade)
